...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/skin.estuary.modv2_VST-HK3_IPTV/')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org/config_skins/estuary/skin.estuary.modv2_VST-HK3_IPTV.zip'
save_path = os.path.join(save_directory, 'skin.estuary.modv2_VST-HK3_IPTV.zip')
