...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/skin.arctic.fuse_VSTseul_Foxx_Noos_Bazoluc/')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org/config_skins/Arctic%20Fuse/actic%20fuse%20bazoland%20luc/skin.arctic.fuse_VSTseul_Foxx_Noos_Bazoluc.zip'
save_path = os.path.join(save_directory, 'skin.arctic.fuse_VSTseul_Foxx_Noos_Bazoluc.zip')
...
if download_successful:
    ...
    source_dir1 = xbmcvfs.translatePath('special://home/temp/temp/skin.arctic.fuse_VSTseul_Foxx_Noos_Bazoluc/')
