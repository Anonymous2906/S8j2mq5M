...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/skin.arctic.horizon.2_HK3-VST_IPTV/')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org/config_skins/ah2/skin.arctic.horizon.2_HK3-VST_IPTV.zip'
save_path = os.path.join(save_directory, 'skin.arctic.horizon.2_HK3-VST_IPTV.zip')
