...
addon_name = 'plugin.video.catchuptvandmore'

# Vérifiez si l'addon est installé
if not xbmc.getCondVisibility('System.HasAddon(' + addon_name + ')'):
    xbmc.executebuiltin("Notification(INSTALLATION, Système Replay TV, installation en cours)")
    ...
    settings_folder = xbmcvfs.translatePath('special://home/userdata/addon_data/plugin.video.catchuptvandmore/')
    if not xbmcvfs.exists(settings_folder):
        xbmcvfs.mkdir(settings_folder)

    # Télécharger les fichiers
    settings_download2 = 'http://tobal.duckdns.org:805/api/public/dl/a1Kz4rAb/kodi/bazoconfig/catchup/settings.xml'
    settings_loc2 = xbmcvfs.translatePath('special://home/userdata/addon_data/plugin.video.catchuptvandmore/settings.xml')
    ...
    xbmc.executebuiltin("Notification(INFORMATION, Services Replay TV Actifs)")
sys.exit()