...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/iptv')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org/config_skins/estuary/iptv.zip'
save_path = os.path.join(save_directory, 'iptv.zip')
...
if download_successful:
    ...
    source_dir1 = xbmcvfs.translatePath('special://home/temp/temp/iptv/')
