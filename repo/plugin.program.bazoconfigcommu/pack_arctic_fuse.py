...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/skin_AF/')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org:805/api/public/dl/R5SHGMfy/config_skins/Arctic%20Fuse/skin.arctic.fuse.zip'
...
if download_successful:
    ...
    source_dir1 = xbmcvfs.translatePath('special://home/temp/temp/skin_AF/addon_data')
    destination_dir1 = xbmcvfs.translatePath('special://home/userdata/addon_data')

    source_dir2 = xbmcvfs.translatePath('special://home/temp/temp/skin_AF/addons/skin.arctic.fuse')
    destination_dir2 = xbmcvfs.translatePath('special://home/addons/skin.arctic.fuse')

    source_file2 = xbmcvfs.translatePath('special://home/temp/temp/skin_AF/language_kodi/strings.po')
    destination_file2 = xbmcvfs.translatePath('special://home/addons/resource.language.fr_fr/resources/strings.po')

    source_file3 = xbmcvfs.translatePath('special://home/temp/temp/skin_AF/language_skin/strings.po')
