...
xbmc.executebuiltin("Notification(INFORMATION, Import de la liste TV FOXX.)")
...
def extract_rentry():
    ...
    num_rentry = addon.getSetting("codem3u")
...
if __name__ == "__main__":
    ...
    xbmc.executebuiltin("Notification(INFORMATION, Liste des Chaînes FOXX active.)")