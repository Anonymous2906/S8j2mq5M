...
def modif_option():
    ...
    add_dir("[B]2. Codes Secondaires[/B]", 'cuu', artworkPath +'Logo Codes.png', "Permet d'importer et de gérer les Codes Secondaires afin de poursuivre la configuration.")
    add_dir("[B]3. Référentiels :[/B] Installation des Dépôts nécessaires", 'men_repos', artworkPath + 'Logo Dépot.png', "Permet d'installer tous les dépôts en une fois, pour le bon fonctionnement du service Bazoland.")
    add_dir("[B]4. U2Pplay :[/B] Installation/Paramétrage", 'men_ext', artworkPath + 'Logo U2Pplay.png', "Menu de configuration pour U2Pplay.")
    add_dir("[B]5. vStream :[/B] Installation/Paramétrage", 'vodt', artworkPath + 'Logo Vstream.png', "Menu de configuration pour vStream.")
    add_dir("[B]6. TV & Replay :[/B] Installation/Paramétrage", 'men_pvr', artworkPath + 'Logo TV.png', "Menu de configuration pour la TV & Replay.")
    add_dir("[B]7. IPTV :[/B] Mode Stalker & Xtream", 'men_iptv', artworkPath + 'Logo IPTV.png', "Menu de configuration pour l'IPTV de U2pplay.")
    add_dir("[B]8. Skins :[/B] Base de données de Skins", 'men_skin', artworkPath + 'Logo Skin.png', "Menu de Téléchargement et de Gestion des Skins.")
