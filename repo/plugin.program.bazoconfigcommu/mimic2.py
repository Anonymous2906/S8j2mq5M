...
save_directory = xbmcvfs.translatePath('special://home/temp/temp/skin.mimic.lr_EnCoursFusionne_HK3_VST_IPTV/')
xbmcvfs.mkdirs(save_directory)

# Téléchargement et extraction du zip
zipurl = 'http://tobal.duckdns.org/config_skins/mimic/skin.mimic.lr_EnCoursFusionne_HK3_VST_IPTV.zip'
save_path = os.path.join(save_directory, 'skin.mimic.lr_EnCoursFusionne_HK3_VST_IPTV.zip')
